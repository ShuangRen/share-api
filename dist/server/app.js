...
exports.default = (function () {
    ...
    router.get('/favicon.ico', function (ctx, next) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, send(ctx, ctx.path, { root: __dirname + "/../build/" })];
                case 1:
    ...
    router.get('/manifest.json', function (ctx, next) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, send(ctx, ctx.path, { root: __dirname + "/../build/" })];
                case 1:
